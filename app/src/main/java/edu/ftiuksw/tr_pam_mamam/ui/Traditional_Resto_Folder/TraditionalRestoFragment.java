...
public class TraditionalRestoFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mPrasmanan = view.findViewById(R.id.btn_prasmanan);
        mAngkringan = view.findViewById(R.id.btn_angkringan);
        ...
        mAngkringan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(),Angkringan.class);
                startActivity(intent);
            }
        });
        mPrasmanan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(),prasmanan.class);
                startActivity(intent);
            }
        });
